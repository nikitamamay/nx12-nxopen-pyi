# module 'NXOpen.Features.PlatformTestNamespace1'
#
...
class TestBlockFeatureBuilder(NXOpen.Features.FeatureBuilder):
    ...
    To create a new instance of this class, use :py:meth:`NXOpen.NXPlatformTestSession.CreateFeaturesTestBlockFeatureBuilder1`
...
class TestBlock(NXOpen.Features.BodyFeature):
    ...
    To create or edit an instance of this class, use :py:class:`NXOpen.Features.PlatformTestNamespace1.TestBlockFeatureBuilder`
